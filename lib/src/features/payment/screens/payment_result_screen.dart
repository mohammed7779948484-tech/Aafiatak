        ...
        child: Column(
          ...
          children: [
            const AafiatakStatusBlock(
              ...
              message: 'تم التحقق من نجاح الدفع الكامل.',
            ...
            const AafiatakStatusBlock(
              ...
              message: 'تم إنشاء موعد مؤكد لهذا الحجز.',
              tone: AafiatakFeedbackTone.success,
            ...
            AafiatakCard(
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.stretch,
                children: [
                  const AafiatakSectionHeading(label: 'تفاصيل العملية'),
                  const SizedBox(height: AafiatakSpacing.space12),
                  AafiatakInfoRows(
                    rows: const [
                      InfoRowItem(
                        label: 'المبلغ',
                        value: BookingMockData.amount,
                        isLtr: true,
                      ),
                      InfoRowItem(
                        label: 'مرجع الدفع',
                        value: PaymentMockData.paymentReference,
                        isLtr: true,
                      ),
                      InfoRowItem(
                        label: 'رقم الحجز',
                        value: PaymentMockData.bookingNumber,
                        isLtr: true,
                      ),
                    ],
                  ),
